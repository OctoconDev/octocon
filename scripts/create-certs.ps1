...
# (host/Interfold.Bootstrapper) instead. The bootstrapper's CertificatePhase ports this script's
...
#
# Migration: run `dotnet run --project host/Interfold.Bootstrapper -- bootstrap --config interfold.bootstrap.json`
# from a Linux host.
