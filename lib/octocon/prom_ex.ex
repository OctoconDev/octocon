defmodule Octocon.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule OctoconWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Octocon.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: OctoconWeb.Router, endpoint: OctoconWeb.Endpoint},
      Plugins.Ecto,
      Plugins.Oban
    ]
  end
