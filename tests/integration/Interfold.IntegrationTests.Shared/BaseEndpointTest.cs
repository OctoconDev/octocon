...
public class BaseEndpointTest
{
    ...
    public static bool UrlPathStartsWith(string? url, string expectedPrefix)
    {
    ...
    public static HttpRequestMessage BuildMultipartUploadRequest(HttpClient client, string path, string principalId, string fileName, string contentType)
    {
    ...
    public static int ReadTrailingIntFromLocation(HttpResponseMessage response)
    {
    ...
    public static AlterId ReadTrailingAlterIdFromLocation(HttpResponseMessage response)
    ...
    public static async Task<AlterId> CreateAlterAsync(HttpClient client, string principal, string name, string username, VisibilityLevel visibility = VisibilityLevel.Public)
    {
    ...
    public static async Task PatchAlterAsync(HttpClient client, string principal, AlterId alterId, UpdateAlterRequest request)
    {
        using var res = await client.SendAsJsonAsync(
    ...
    public static Task UpdateAlterFieldsAsync(HttpClient client, string principal, AlterId alterId, IReadOnlyList<UpdateAlterFieldRequest> fields)
    ...
    public static Task SetAlterSecurityLevelAsync(HttpClient client, string principal, AlterId alterId, VisibilityLevel securityLevel)
    ...
    public static async Task<TagId> CreateTagAsync(HttpClient client, string principal, string name)
    {
        await EnsureUserExistsAsync(client, principal);
    ...
    public static async Task SetTagSecurityLevelAsync(HttpClient client, string principal, TagId tagId, VisibilityLevel securityLevel)
    {
        using var res = await client.SendAsJsonAsync(
    ...
    public static async Task<FrontId> StartFrontAsync(HttpClient client, string principal, AlterId alterId)
    {
        using var res = await client.SendAsJsonAsync(
    ...
    public static Task<HttpResponseMessage> SendFrontStartAsync(
        HttpClient client,
        AlterId alterId,
        string? comment,
    ...
    public static Task<HttpResponseMessage> SendFrontEndAsync(
        HttpClient client,
        AlterId alterId,
        string principal = "fronting-default-principal")
        => client.SendAsJsonAsync(
    ...
    public static Task<HttpResponseMessage> SendFrontSetAsync(
        HttpClient client,
        AlterId alterId,
        string principal,
        string? comment = null)
    ...
    public static async Task SendFriendRequestAndAcceptAsync(HttpClient client, string sender, string recipient)
    {
    ...
    public static async Task SetFriendTrustAsync(HttpClient client, string principal, string friendId)
    {
        using var res = await client.SendAsJsonAsync(
    ...
    public static async Task<FieldId> CreateSettingsFieldAsync(HttpClient client, string principal, string fieldName, FieldType type, VisibilityLevel securityLevel)
    {
        using var res = await client.SendAsJsonAsync(
    ...
    public static async Task RunSoakAsync(InterfoldWebApplicationFactory factory,
    ...
    public static async Task<string> CreateRandomToken(InterfoldWebApplicationFactory factory, string systemId)
    {
    ...
    public static void AttachPrincipalAuth(HttpRequestMessage request, HttpClient client, string principal)
    {
